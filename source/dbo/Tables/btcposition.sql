CREATE TABLE [dbo].[btcposition] (
    ...
    CONSTRAINT [FK_btcposition_batch] FOREIGN KEY ([batch]) REFERENCES [dbo].[batch] ([id]) ON DELETE CASCADE,
    CONSTRAINT [FK_btcposition_request] FOREIGN KEY ([request]) REFERENCES [dbo].[request] ([id])
);
