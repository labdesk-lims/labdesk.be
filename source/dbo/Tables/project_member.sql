CREATE TABLE [dbo].[project_member] (
    ...
    CONSTRAINT [FK_project_member_project] FOREIGN KEY ([project]) REFERENCES [dbo].[project] ([id]) ON DELETE CASCADE,
    CONSTRAINT [FK_project_member_users] FOREIGN KEY ([users]) REFERENCES [dbo].[users] ([id])
);
