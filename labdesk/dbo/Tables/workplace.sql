CREATE TABLE [dbo].[workplace] (
    ...
    [deactivate]  BIT            CONSTRAINT [DF_workplace_deactivate] DEFAULT ((0)) NOT NULL,
    [department]  INT            NULL,
    CONSTRAINT [PK_workplace] PRIMARY KEY CLUSTERED ([id] ASC),
    CONSTRAINT [FK_workplace_department] FOREIGN KEY ([department]) REFERENCES [dbo].[department] ([id])
);
