CREATE TABLE [dbo].[smppoint] (
    ...
    [customer]    INT            NULL,
    [deactivate]  BIT            CONSTRAINT [DF_smppoint_deactivate] DEFAULT ((0)) NULL,
    CONSTRAINT [PK_smppoint] PRIMARY KEY CLUSTERED ([id] ASC),
    CONSTRAINT [FK_smppoint_customer] FOREIGN KEY ([customer]) REFERENCES [dbo].[customer] ([id]) ON DELETE CASCADE
);
